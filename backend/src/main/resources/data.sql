...
CURDATE()),
  ...
  ('Article about Markdown', 'Some guy', '#### Article utilisant Markdown
...
(Maybe this article was written by Yoan, who knows?)', CURDATE());

INSERT INTO articles (title, author, content, date, thumbnail) VALUES 
('Fifth article', 'Maybe Yoan Guerineau', 'This one will only be a few words long.', CURDATE(), 'https://i.pinimg.com/originals/73/c4/c1/73c4c12d67609edb85c7e62b49be5c72.jpg'),
('Sixth article', 'Maybe Not Yoan Guerineau', 'Today I am writing an article that will take a few lines because we need to see how it fits with a thumbnail. Thumbnails could look great and will maybe make our users click more on the articles they see.
