...
Donec in volutpat ante. Sed ex arcu, tincidunt ac blandit et, mollis sit amet eros. Praesent feugiat turpis enim, mattis feugiat diam dictum in. Duis mollis rhoncus urna, at venenatis ligula. Sed id ligula non diam sagittis sodales nec eget massa. Maecenas sit amet nulla nisi. Morbi a orci id dui lobortis fringilla quis ut odio. Mauris ut orci maximus, consectetur nunc sit amet, convallis enim. Integer vehicula porttitor dui vitae fermentum. Nullam non diam quam. Suspendisse cursus tempus euismod. Aenean vel tortor eget ligula aliquam rhoncus eu nec justo. Suspendisse quis vestibulum neque.', 
  ...
  (
    'Another article',
    'Yoan Guerineau',
    'Here is the second article on esiea-delta. This article will be a short one. It is all about filling the space with some dummy text you know... No, you won''t get nor learn anything reading this, you can stop reading this.
...
I think I will stop writing just now as I''m running out of ideas to simply fill all that blank space. Thank you for reading this though, I hope you had some fun reading this whole thing even though you didn''t get anything from it.', 
  ...
  (
    'Third article',
    'Not Yoan Guerineau',
    'This is the third article and it''s a short one to see how it goes with short text.',
    NOW()
  ),
  (
    'Article about Markdown',
    'Some guy',
    '#### Article utilisant Markdown
I am writing this article using **Markdown**. With Markdown, you can easily make lists and any kind of "special" content.
- This
- Is
- A 
- List
...
I can even add [links](https://google.com)

There is a lot of other things you can do with Markdown ! Check it out [here](https://www.markdownguide.org/cheat-sheet/)!

(Maybe this article was written by Yoan, who knows?)',
    NOW()
  );
...
INSERT INTO articles (title, author, content, date, thumbnail) VALUES 
  (
    'Fifth article',
    'Maybe Yoan Guerineau',
    'This one will only be a few words long.',
    NOW(),
    'https://i.pinimg.com/originals/73/c4/c1/73c4c12d67609edb85c7e62b49be5c72.jpg'
  ),
  (
    'Sixth article',
    'Maybe Not Yoan Guerineau',
    'Today I am writing an article that will take a few lines because we need to see how it fits with a thumbnail. Thumbnails could look great and will maybe make our users click more on the articles they see.
...
I do think that headlines mixed up with thumbnails are super effective when used well. An "intense" almost clickbaiting headline mixed with an explosive eye-catching thumbnail would really get me to click on an article more than another.',
    NOW(),
    'https://i.pinimg.com/originals/73/c4/c1/73c4c12d67609edb85c7e62b49be5c72.jpg'
  );
...
INSERT INTO comments (author, content, date) VALUES
  (
    'Yoan Guerineau',
    'Really nice article, I didn''t understand anything but it is looking good!',
    NOW()
  ),
  (
    'Some guy',
    'Sed ex arcu, tincidunt ac blandit et, mollis sit amet eros. Praesent feugiat turpis enim, mattis feugiat diam dictum in. Duis mollis rhoncus urna, at venenatis ligula. Sed id ligula non diam sagittis sodales nec eget massa. Maecenas sit amet nulla nisi. Morbi a orci id dui lobortis fringilla quis ut odio. Mauris ut orci maximus, consectetur nunc sit amet, convallis enim. Integer vehicula porttitor dui vitae fermentum. Nullam non diam quam. Suspendisse cursus tempus euismod.',
    NOW()
  ),
  (
    'Markdown Lover',
    'This article about Markdown is really nice, I really love Markdown! The article looks a bit short but it is sufficient to understant the power of Markdown and what you can do with it. Keep up the good work "Some guy"',
    NOW()
  ),
  (
    'Thumbnail Lover',
    'Thumbnails are looking super great!',
    NOW()
  ),
  (
    'Thumbnail Lover',
    'Thumbnails are indeed super good at catching your eye, used well it can be a super powerful weapon! I really like how you actually got the thumbnails into the Article, it''s looking really nice!',
    NOW()
  );

INSERT INTO comment_article (comment_id, article_id) VALUES
  (1,1),
  (2,1),
  (3,4),
  (4,5),
